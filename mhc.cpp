...
int main(int argc, char *argv[])
{
  ...
  filterRGRB[0][2] =  1.0 / 16;
  filterRGRB[1][1] = - 1.0 / 8;
  filterRGRB[1][3] = - 1.0 / 8;
  filterRGRB[2][0] = - 1.0 / 8;
  filterRGRB[2][1] = 4.0 / 8;
  filterRGRB[2][2] = 5.0 / 8;
  filterRGRB[2][3] = 4.0 / 8;
  filterRGRB[2][4] = - 1.0 / 8;
  filterRGRB[3][1] = - 1.0 / 8;
  filterRGRB[3][3] = - 1.0 / 8;
  filterRGRB[4][2] = 1.0 / 16;

  filterRGBR[0][2] = - 1.0 / 8;
  filterRGBR[1][1] = - 1.0 / 8;
  filterRGBR[1][2] = 4.0 / 8;
  filterRGBR[1][3] = - 1.0 / 8;
  filterRGBR[2][0] = 1.0 / 16;
  filterRGBR[2][2] = 5.0 / 8;
  filterRGBR[2][4] = 1.0 / 16;
  filterRGBR[3][1] = - 1.0 / 8;
  filterRGBR[3][2] = 4.0 / 8;
  filterRGBR[3][3] = - 1.0 / 8;
  filterRGBR[4][2] = - 1.0 / 8;

  filterRBBB[0][2] = - 3.0 / 16;
  filterRBBB[1][1] = 2.0 / 8;
  filterRBBB[1][3] = 2.0 / 8;
  filterRBBB[2][0] = - 3.0 / 16;
  filterRBBB[2][2] = 6.0 / 8;
  filterRBBB[2][4] = - 3.0 / 16;
  filterRBBB[3][1] = 2.0 / 8;
  filterRBBB[3][3] = 2.0 / 8;
  filterRBBB[4][2] = - 3.0 / 16;

  filterBGRB[0][2] = - 1.0 / 8;
  filterBGRB[1][1] = - 1.0 / 8;
  filterBGRB[1][2] = 4.0 / 8;
  filterBGRB[1][3] = - 1.0 / 8;
  filterBGRB[2][0] = 1.0 / 16;
  filterBGRB[2][2] = 5.0 / 8;
  filterBGRB[2][4] = 1.0 / 16;
  filterBGRB[3][1] = - 1.0 / 8;
  filterBGRB[3][2] = 4.0 / 8;
  filterBGRB[3][3] = - 1.0 / 8;
  filterBGRB[4][2] = - 1.0 / 8;

  filterBGBR[0][2] =  1.0 / 16;
  filterBGBR[1][1] = - 1.0 / 8;
  filterBGBR[1][3] = - 1.0 / 8;
  filterBGBR[2][0] = - 1.0 / 8;
  filterBGBR[2][1] = 4.0 / 8;
  filterBGBR[2][2] = 5.0 / 8;
  filterBGBR[2][3] = 4.0 / 8;
  filterBGBR[2][4] = - 1.0 / 8;
  filterBGBR[3][1] = - 1.0 / 8;
  filterBGBR[3][3] = - 1.0 / 8;
  filterBGBR[4][2] = 1.0 / 16;

  filterBRRR[0][2] = - 3.0 / 16;
  filterBRRR[1][1] = 2.0 / 8;
  filterBRRR[1][3] = 2.0 / 8;
  filterBRRR[2][0] = - 3.0 / 16;
  filterBRRR[2][2] = 6.0 / 8;
  filterBRRR[2][4] = - 3.0 / 16;
  filterBRRR[3][1] = 2.0 / 8;
  filterBRRR[3][3] = 2.0 / 8;
  filterBRRR[4][2] = - 3.0 / 16;
